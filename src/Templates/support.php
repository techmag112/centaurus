<?php 
    $this->layout('template', ['title' => 'VPC | VoIP платформа Центавр - Техническая поддержка']); 
?>

<?php $this->insert('header', ['style' => 'background-position: center; background: linear-gradient(180deg,#0e223a 11.98%,rgba(22,73,131,.38) 51.04%,#0e223a 92.19%),url(../img/header/support.jpg)', 'block' => 'header_block4', 'link_main_page' => 'href=/'] ) ?>
